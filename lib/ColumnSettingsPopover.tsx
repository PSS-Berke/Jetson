...
import { BaseColumnConfig } from "./columnConfig";

interface ColumnSettingsPopoverProps<T extends BaseColumnConfig> {
  columnOrder: string[];
  ...
  // Optional: columns to exclude from the settings UI (e.g., "time_range" placeholders)
  excludeTypes?: string[];
}

export default function ColumnSettingsPopover<T extends BaseColumnConfig>({
  columnOrder,
  hiddenColumns,
  columns,
  getColumnByKey,
