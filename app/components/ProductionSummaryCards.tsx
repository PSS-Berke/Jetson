...
export default function ProductionSummaryCards({ comparisons }: ProductionSummaryCardsProps) {
  const summary = comparisons.length > 0 ? calculateProductionSummary(comparisons) : null;
  ...
  const cards = [
    ...
    },
    {
      ...
      color: summary.completion_rate >= 95 ? 'green' : summary.completion_rate >= 80 ? 'yellow' : 'red',
    },
    {
