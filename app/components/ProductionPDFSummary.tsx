...
export default function ProductionPDFSummary({
  summary,
}: ProductionPDFSummaryProps) {
    ...
    <div className="pdf-summary mb-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        >
          ...
          >
            {summary.total_variance >= 0 ? "+" : ""}
            {formatNumber(summary.total_variance)}
          </div>
          <div
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 border-l-4 border-teal-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-teal-600 font-medium mb-1 uppercase tracking-wide">
            Jobs Ahead/On Target
          </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 p-3 rounded-lg shadow-sm">
            ...
            <div className="text-xs text-green-600 mt-1">
              {formatPercentage(
                (summary.jobs_ahead / summary.total_jobs) * 100,
              )}
            </div>
          </div>
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-200 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-yellow-600 font-medium uppercase tracking-wide mb-1">
              On Track
            </div>
            ...
            <div className="text-xs text-yellow-600 mt-1">
              {formatPercentage(
                (summary.jobs_on_track / summary.total_jobs) * 100,
              )}
            </div>
          </div>
          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 p-3 rounded-lg shadow-sm">
            ...
            <div className="text-xs text-red-600 mt-1">
              {formatPercentage(
                (summary.jobs_behind / summary.total_jobs) * 100,
              )}
            </div>
          </div>
        </div>
