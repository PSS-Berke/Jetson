    ...
    <div className="pdf-tables space-y-8">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Client concentration and revenue distribution by account
              </p>
            </div>
          </div>
        </div>
          ...
          <table className="w-full border-collapse text-[11px]">
            <thead>
              <tr className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                <th className="px-4 py-3 text-left font-bold border-r border-blue-500">
                  Rank
                </th>
                <th className="px-4 py-3 text-left font-bold border-r border-blue-500">
                  Client Name
                </th>
                <th className="px-4 py-3 text-right font-bold border-r border-blue-500">
                  Revenue
                </th>
                <th className="px-4 py-3 text-right font-bold border-r border-blue-500">
                  Jobs
            ...
            <tbody>
              {topClients.length === 0 ? (
                <tr>
                  <td
                    colSpan={8}
                    className="px-4 py-12 text-center text-gray-500 bg-gray-50"
                  >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <span
                          className={`${riskColors.bg} ${riskColors.text} px-3 py-1 rounded-full font-bold text-xs border ${riskColors.border}`}
                        >
      ...
      <div className="page-break-before">
        <div className="mb-4 pb-3 border-b-2 border-purple-600">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">
                Service Type Revenue Mix
              </h2>
              <p className="text-sm text-gray-600">
                Revenue distribution across different process types and services
              </p>
            </div>
          </div>
        </div>
          ...
          <table className="w-full border-collapse text-[11px]">
            <thead>
              <tr className="bg-gradient-to-r from-purple-600 to-purple-700 text-white">
                <th className="px-4 py-3 text-left font-bold border-r border-purple-500">
                  Service Type
                </th>
                <th className="px-4 py-3 text-right font-bold border-r border-purple-500">
                  Revenue
                </th>
                <th className="px-4 py-3 text-right font-bold border-r border-purple-500">
                  Jobs
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm font-medium">
                        No service type data available for this period
                      </p>
                    </div>
                  </td>
                </tr>
        ...
        {serviceTypes.length > 0 && (
          <div className="mt-3 text-xs text-gray-600 flex items-center">
            ...
            <span className="font-medium">
              Total service types: {serviceTypes.length} | Revenue concentration
              in top service:{" "}
              {formatPercentage(serviceTypes[0]?.percentageOfTotal || 0)}
            </span>
          </div>
        )}
      </div>
            ...
            <table className="w-full border-collapse text-[11px]">
              <thead>
                <tr className="bg-gradient-to-r from-green-600 to-green-700 text-white">
                  <th className="px-4 py-3 text-left font-bold border-r border-green-500">
                    Metric
                  </th>
                  <th className="px-4 py-3 text-right font-bold border-r border-green-500">
                    Current Period
                  </th>
                  <th className="px-4 py-3 text-right font-bold border-r border-green-500">
                    Previous Period
                ...
                {periodComparison.map((comparison, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className={`px-4 py-3 text-right font-bold border-r border-gray-200 ${changeColors.text}`}
                      >
                        <span
                          className={`${changeColors.bg} px-2 py-1 rounded`}
                        >
                          {comparison.change >= 0 ? "+" : ""}
                          {comparison.metric === "Revenue" ||
                          comparison.metric === "Avg Job Value"
                      ...
                      <td
                        className={`px-4 py-3 text-right font-bold ${changeColors.text}`}
                      >
      ...
      {jobsWithCosts && jobsWithCosts.length > 0 && (
        <div className="page-break-before">
          <div className="mb-4 pb-3 border-b-2 border-indigo-600">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Detailed cost and margin analysis by individual job
                </p>
              </div>
            </div>
          </div>
            ...
            <table className="w-full border-collapse text-[10px]">
              <thead>
                <tr className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
                  <th className="px-3 py-3 text-left font-bold border-r border-indigo-500">
                    Job #
                  </th>
                  <th className="px-3 py-3 text-left font-bold border-r border-indigo-500">
                    Client
                  </th>
                  <th className="px-3 py-3 text-right font-bold border-r border-indigo-500">
                    Revenue
                  </th>
                  <th className="px-3 py-3 text-right font-bold border-r border-indigo-500">
                    Cost
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-gray-700 border-r border-gray-200 text-xs">
                      ...
                      {typeof job.client === "object" && job.client
                        ...
                        : job.client || "Unknown"}
                      {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                      {(job as any).sub_client &&
                        ` / ${(job as any).sub_client.name}`}
                    </td>
                    ...
                    <td
                      className={`px-3 py-2 text-right font-bold border-r border-gray-200`}
                    >
                      {job.profit !== undefined ? (
                        <span
                          className={`${(job.profit || 0) >= 0 ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"} px-2 py-1 rounded`}
                        >
                    ...
                    <td className="px-3 py-2 text-right font-bold">
                      {job.profitMargin !== undefined ? (
                        <span
                          className={`${(job.profitMargin || 0) >= 0 ? "text-green-700" : "text-red-700"}`}
                        >
          ...
          <div className="mt-3 text-xs text-gray-600 flex items-center">
            ...
            <span className="font-medium">
              Showing {jobsWithCosts.length} jobs with complete cost data
            </span>
          </div>
        </div>
      )}
      ...
      <div className="mt-8 pt-6 border-t-2 border-gray-300">
        <div className="flex items-start text-xs text-gray-500">
          ...
          <p>
            <span className="font-semibold">Note:</span> All financial data
            presented in this report is based on current projections and
            recorded transactions as of the report generation date. Figures may
            be subject to adjustment pending final reconciliation and invoice
            processing.
          </p>
        </div>
      </div>
