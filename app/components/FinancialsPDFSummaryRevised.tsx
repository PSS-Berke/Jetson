...
export default function FinancialsPDFSummaryRevised({
  ...
  const getHealthScore = () => {
    let score = 0;
    if (summary.capacityUtilization >= 60 && summary.capacityUtilization <= 85)
      score += 25;
    ...
    <div className="pdf-summary mb-8">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Key performance metrics and business health indicators
              </p>
            </div>
          </div>
          ...
          <div
            className={`bg-gradient-to-br from-${healthColor}-50 to-${healthColor}-100 border-2 border-${healthColor}-300 rounded-lg px-6 py-4 text-center shadow-lg`}
          >
            <div className="text-xs font-semibold text-${healthColor}-600 uppercase tracking-wide mb-1">
              Business Health
            </div>
            <div className={`text-4xl font-bold text-${healthColor}-900 mb-1`}>
              {healthScore}
            </div>
            <div className={`text-sm font-semibold text-${healthColor}-700`}>
              {healthLabel}
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 text-white p-5 rounded-xl shadow-lg">
            ...
            <div className="text-3xl font-bold mb-1">
              {formatCurrency(summary.averageJobValue)}
            </div>
            <div className="text-xs opacity-75">
              Per Job Revenue: {formatCurrency(revenuePerJob)}
            </div>
          </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div
            className={`relative overflow-hidden rounded-xl shadow-lg p-5 ${
              summary.capacityUtilization > 85
                ? "bg-gradient-to-br from-orange-500 to-red-600"
                : summary.capacityUtilization < 40
          ...
          <div
            className={`relative overflow-hidden rounded-xl shadow-lg p-5 ${
              summary.topClientConcentration > 30
                ...
                : summary.topClientConcentration > 20
                  ? "bg-gradient-to-br from-yellow-500 to-orange-600"
          ...
          <div
            className={`relative overflow-hidden rounded-xl shadow-lg p-5 ${
              (summary.jobsAtRisk || 0) > 5
                ? "bg-gradient-to-br from-red-500 to-red-700"
                : (summary.jobsAtRisk || 0) > 0
                  ? "bg-gradient-to-br from-yellow-500 to-orange-600"
          ...
          {periodGrowth !== undefined ? (
            ...
            >
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <svg
                    className={`w-5 h-5 opacity-75 ${periodGrowth >= 0 ? "" : "transform rotate-180"}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="bg-gradient-to-br from-gray-400 to-gray-500 rounded-xl shadow-lg p-5 text-white">
              <div className="text-xs font-semibold uppercase tracking-wide opacity-90 mb-3">
                Growth
              </div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-blue-50 border-2 border-blue-200 rounded-xl p-6 shadow-md">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white border-2 border-purple-100 p-4 rounded-lg shadow-sm">
            <div className="text-xs text-purple-600 font-bold uppercase tracking-wide mb-2">
              Service Mix
            </div>
            <div
              className="text-lg font-bold text-purple-900 mb-1 truncate"
              title={primaryProcessType}
            >
              {primaryProcessType}
            </div>
          ...
          <div className="bg-white border-2 border-green-100 p-4 rounded-lg shadow-sm">
            <div className="text-xs text-green-600 font-bold uppercase tracking-wide mb-2">
              Job Economics
            </div>
