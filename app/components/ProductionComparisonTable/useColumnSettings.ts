...
interface UseColumnSettingsReturn {
  ...
  visibleColumns: ProductionColumnConfig[];
...
export function useColumnSettings(): UseColumnSettingsReturn {
  ...
  const visibleColumns = useMemo((): ProductionColumnConfig[] => {
    ...
    return columnSettings.order
      ...
      .filter((col): col is ProductionColumnConfig => col !== undefined);
  }, [columnSettings]);
