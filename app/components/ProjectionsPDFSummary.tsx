    ...
    <div className="pdf-summary mb-6">
      ...
      <div className="grid grid-cols-5 gap-3 mb-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-blue-600 font-medium mb-1 uppercase tracking-wide">Total Jobs</div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 border-l-4 border-green-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-green-600 font-medium mb-1 uppercase tracking-wide">Total Revenue</div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-l-4 border-purple-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-purple-600 font-medium mb-1 uppercase tracking-wide">Total Quantity</div>
          <div className="text-2xl font-bold text-purple-900">{formatNumber(totalQuantity)}</div>
        </div>

        {/* Service Types */}
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-l-4 border-orange-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-orange-600 font-medium mb-1 uppercase tracking-wide">Service Types</div>
          <div className="text-2xl font-bold text-orange-900">{serviceTypeCount}</div>
        </div>

        {/* Average per Period */}
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-l-4 border-indigo-500 p-3 rounded-lg shadow-sm">
          <div className="text-xs text-indigo-600 font-medium mb-1 uppercase tracking-wide">Avg per {getPeriodLabel()}</div>
          <div className="text-2xl font-bold text-indigo-900">{formatNumber(averagePerPeriod)}</div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="grid grid-cols-4 gap-3">
          {serviceSummaries.filter(summary => summary.serviceType.toLowerCase() !== 'insert').map(summary => (
            <div key={summary.serviceType} className="bg-white border-2 border-gray-200 hover:border-blue-300 p-3 rounded-lg shadow-sm">
              <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">{summary.serviceType}</div>
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Insert</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Sort</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Inkjet</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Label/Apply</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Fold</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">Laser</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
          ...
          <div className="bg-white border-2 border-gray-200 hover:border-purple-300 p-3 rounded-lg shadow-sm">
            <div className="text-xs text-gray-500 font-medium uppercase tracking-wide">HP Press</div>
            <div className="text-lg font-bold text-gray-900 mt-1">
