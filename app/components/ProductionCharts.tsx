    ...
    return (
      <div className="bg-white rounded-lg shadow p-12">
        <div className="text-center space-y-6">
          ...
          {/* Message */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">No Production Data Yet</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              Start tracking production by adding actual quantities to your jobs.
              Charts will appear here showing projected vs actual comparisons.
            </p>
          </div>

          {/* Placeholder preview */}
          <div className="max-w-2xl mx-auto pt-4 space-y-4">
            <div className="text-xs text-gray-400 font-medium text-left">Preview: What you&apos;ll see</div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          {topJobs.map((comparison) => {
            ...
            const projectedWidth = Math.max((comparison.projected_quantity / maxValue) * 100, 2);
            const actualWidth = Math.max((comparison.actual_quantity / maxValue) * 100, 2);
