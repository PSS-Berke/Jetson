...
export default function FinancialsPDFHeader({
  dateRange,
  granularity,
  facility,
  selectedClients,
  ...
  return (
    <div className="pdf-header mb-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4 rounded-t-lg mb-4">
        <h1 className="text-2xl font-bold">Financial Analysis Report</h1>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-gray-900">{getGranularityLabel()}</div>
            </div>
          </div>
        </div>
      </div>
