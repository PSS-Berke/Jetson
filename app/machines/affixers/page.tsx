...
export default function Affixers() {
  ...
  // Filter machines to only show affixers
  const affixers = machines.filter(machine =>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <nav className="mb-6">
          <ol className="flex items-center gap-2 text-sm">
            ...
            <li className="text-[var(--text-dark)] font-medium">Affixers</li>
          </ol>
        </nav>
        ...
        <div className="flex items-center justify-between mb-6 pb-6 border-b border-[var(--border)]">
          <div className="flex items-center gap-6">
            <h2 className="text-2xl font-bold text-[var(--dark-blue)]">Affixer Machines</h2>
            <FacilityToggle
        ...
        {machinesError ? (
          ...
          <div className="text-center py-12">
            <div className="text-[var(--text-light)]">Loading affixers...</div>
          </div>
        ) : (
